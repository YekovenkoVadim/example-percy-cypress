...
describe('TodoMVC', function () {
    ...
    it.skip('Test #1. Check window and title', () => {
        cy.document().should('have.property', 'charset').and('eq', 'UTF-8');
        cy.title().should('contain', 'WebDriverUniversity.com');
        cy.percySnapshot('page title');
    });
    it.skip('Test #2. Check sections by visual testing', () => {
        const sectionNames = [
            'CONTACT US',
            'LOGIN PORTAL',
            'BUTTON CLICKS',
    ...
    it.only('Test #3. Check titles of the linked pages', () => {
        const newPageUrl = [
        ...
        (function checkLinksWorking() {
            newPageUrl.forEach((url, index) => {
                ...
                if(url== 'http://www.webdriveruniversity.com/Ajax-Loader/index.html') {cy.wait(10000)};
